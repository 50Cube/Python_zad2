...
class Wolf:
    def __init__(self, distance):
        ...
        logging.info('Ustalenie pozycji poczatkowej wilka: (' + str(self.position[0]) + '; ' + str(self.position[1]) + ')')
    ...
    def check_distance(self, sheeps):
        ...
        logging.debug('wolf.check_distance(sheeps=' + str(sheeps) + ') = ' + str(closest_sheep) + ', ' + str(closest_sheep_distance))
    ...
    def move(self, sheep, distance, sheeps):
        ...
        logging.info('Wilk przemieścił się z punktu: (' + str(old_pos[0]) + '; ' + str(old_pos[1]) + ') do punktu (' + str(self.position[0]) + '; ' + str(self.position[1]) + ')')
